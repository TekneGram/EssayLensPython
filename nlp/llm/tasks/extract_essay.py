...
def build_essay_request(text_tasks: Sequence[str]) -> list[JsonSchemaChatRequest]:
    return [
...
async def run_parallel_extract_essay(
    llm_service: "LlmService",
    app_cfg: "AppConfigShape",
    text_tasks: Sequence[str],
) -> dict[str, Any]:
    requests_ = build_essay_request(text_tasks)
